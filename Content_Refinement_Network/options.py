...
class Options():
    ...
    def init(self, parser):
        ...
        parser.add_argument('--datasets_dir', type=str, default='/mnt/188/b/NTIRE23/data/shadow/train', help='dir of train data')
        parser.add_argument('--train_list', type=str, default='train_7_split.txt', help='dir of train data')

        parser.add_argument('--valset_dir', type=str, default='/mnt/188/b/NTIRE23/data/shadow/train', help='dir of train data')
        parser.add_argument('--validation_list', type=str, default='val_7_split.txt', help='dir of train data')
