...
######### Logs dir ###########
log_dir = os.path.join(dir_name, 'log_ISTD_our', opt.arch+opt.env)
if not os.path.exists(log_dir):
    os.makedirs(log_dir)
shutil.copy("/mnt/188/b/NTIRE23/data/shadow/ShadowFormer/options.py", log_dir)
shutil.copy("/mnt/188/b/NTIRE23/data/shadow/ShadowFormer/dataset.py", log_dir)
...
######### DataParallel ###########
flops, params = profile(model_restoration, inputs=(torch.randn(1, 3, 320,320), torch.randn(1, 1, 320, 320)))
...
train_dataset = get_training_data(opt)
