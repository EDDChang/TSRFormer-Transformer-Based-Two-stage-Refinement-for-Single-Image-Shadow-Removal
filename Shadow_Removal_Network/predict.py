...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained', type=str, required=True, default='/mnt/188/b/NTIRE23/data/shadow/SpA-Former-shadow-removal/results_ISTD/000158/models/gen_model_epoch_759.pth')
